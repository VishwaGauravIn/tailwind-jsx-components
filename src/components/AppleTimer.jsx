...
export default function AppleTimer() {
  ...
  return (
    <>
      {isMounted && (
        <motion.div
          className="w-96 h-20 rounded-full p-4 flex justify-between items-center bg-black shadow-md"
        ...
        >
          ...
          <div className="flex items-end gap-2 text-yellow-500 w-44 h-full">
            ...
            <p
              className="text-[44px] leading-[1] font-thin flex overflow-hidden w-[110px] h-full justify-center"
